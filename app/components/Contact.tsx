...
export default function Contact() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      const recipientEmail = 'madanmohanan13579@gmail.com';

      // Send email using EmailJS
      const result = await emailjs.send(
        'service_wryzrak', // Replace with your EmailJS service ID
        'template_cju5jv8', // Replace with your EmailJS template ID
        {
          name: data.name,
          email: data.email,
          subject: data.subject,
          message: data.message,
          to_email: recipientEmail, // Hard-code recipient email
        },
        'Cg5uv-2OigPfvrQas' // Replace with your EmailJS user ID
      )
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg">
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  madan.511t@gmail.com
                </a>
                <a
                  href="tel:+18624104999"
                  className="flex items-center text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300"
                >
